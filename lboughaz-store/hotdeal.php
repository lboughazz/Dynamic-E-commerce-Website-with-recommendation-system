    ...
    <header>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Hot Deal</h3>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h4 class="title">Hot Deal for this month : </h4>
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										$result = $database->getDataHotDeal();
										while ($row = mysqli_fetch_assoc($result)){
											componentHotDeal($row['productid'],$row['product_name'], $row['productOldPrice'],$row['productNewPrice'], $row['product_image'],$row['product_category'] ,$row['product_sale'], $curPageName );
										}
										?>
										<!-- /product -->
									</div>
