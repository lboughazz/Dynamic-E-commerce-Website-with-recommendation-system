				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb-tree">
							<li><a href="#">Home</a></li>
							<li class="active"><?php echo $_POST['search-content']?></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
                                        ...
                                        $search_content = $_POST['search-content'];
										$search_content_category = $_POST['search-content-category'];
										$curPageName = "cart.php";  
                                        if ($search_content_category == 'none' ){
											    	$result = $database->getSearchData($search_content,"none");
                                                 if (!empty($result) && !empty($search_content)  ) {
                                                     ...
                                                     echo '<div style = "margin : 150 px;" class="alert alert-warning" role="alert"> 
                                                    <h5> No Results Found !!   </h5> <h5><a href="index.php" class="alert-link"> back to the home Page .</a></h5><h5> </h5>
                                                 </div>';
                                                   }
										}else{
											$result = $database->getSearchData($search_content,$search_content_category);
